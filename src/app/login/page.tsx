    ...
    <main className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 py-20 space-y-8 text-left">
      ...
      <section className="space-y-4">
        ...
        <button
          ...
          className="w-full btn-minimal-primary py-3 px-4 flex items-center justify-center gap-2.5 text-sm"
        >
        ...
        <p className="text-xs text-[#888888]">
          Your account name is retrieved from Microsoft Outlook and cannot be altered.
        </p>
      </section>
